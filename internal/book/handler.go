...
func (h *Handler) getAll(w http.ResponseWriter, r *http.Request) {
	...
	middleware.WriteJSON(w, http.StatusOK, books)
}
...
func (h *Handler) create(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		middleware.WriteError(w, http.StatusBadRequest, errors.New("invalid author id"))
		return
	}
	...
	b, err := h.service.Create(r.Context(), authorID, req)
	if err != nil {
...
func (h *Handler) update(w http.ResponseWriter, r *http.Request) {
	...
	b, err := h.service.Update(r.Context(), id, req)
	if err != nil {
		if errors.Is(err, ErrNotFound) {
			middleware.WriteError(w, http.StatusNotFound, err)
			return
